 ...
 * and return a poniter to the game object that collided with the object given as parameter
 * 
 * @return GameObject* 
 */
 ...
 * 
 * @return map adméttant les sprites du groupe comme clés et les sprites du groupe passé en paramètre comme valeur
 */
